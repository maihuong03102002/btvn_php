...
<body>
    <div class="container mt-3">
        ...
        ?>
        <form action="action-update.php?id=<?=$prodArr['id'] ?>" method="POST">
        <div class="mb-3">
            <label class="form-label">Name</label>
            <input required type="text" class="form-control" name="name" value="<?= $prodArr['name']?>">
        </div>
        <div class="mb-3">
            <label class="form-label">Price</label>
            <input required type="text" class="form-control" name="price" value="<?= $prodArr['price']?>">
        </div>
        <div class="mb-3">
